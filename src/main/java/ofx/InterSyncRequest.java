 ...
 *       
 * 
 * <p>Java class for InterSyncRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InterSyncRequest">
 *   &lt;complexContent>
 ...
 *         &lt;/choice>
 *         &lt;element name="INTERTRNRQ" type="{http://ofx.net/types/2003/04}InterTransactionRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "InterSyncRequest", propOrder = {
    "bankacctfrom",
    "ccacctfrom",
    "intertrnrq"
})
public class InterSyncRequest
    extends AbstractSyncRequest
{
    ...
    @XmlElement(name = "INTERTRNRQ")
    protected List<InterTransactionRequest> intertrnrq;
    ...
    /**
     * Gets the value of the intertrnrq property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the intertrnrq property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getINTERTRNRQ().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<InterTransactionRequest> getINTERTRNRQ() {
        if (intertrnrq == null) {
            intertrnrq = new ArrayList<InterTransactionRequest>();
        }
        return this.intertrnrq;
    }
