 ...
 *       
 * 
 * <p>Java class for MailSyncRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MailSyncRequest">
 *   &lt;complexContent>
 ...
 *         &lt;element name="MAILTRNRQ" type="{http://ofx.net/types/2003/04}MailTransactionRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "MailSyncRequest", propOrder = {
    "incimages",
    "usehtml",
    "mailtrnrq"
})
public class MailSyncRequest
    extends AbstractSyncRequest
{
    ...
    @XmlElement(name = "MAILTRNRQ")
    protected List<MailTransactionRequest> mailtrnrq;
    ...
    /**
     * Gets the value of the mailtrnrq property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the mailtrnrq property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMAILTRNRQ().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MailTransactionRequest> getMAILTRNRQ() {
        if (mailtrnrq == null) {
            mailtrnrq = new ArrayList<MailTransactionRequest>();
        }
        return this.mailtrnrq;
    }
