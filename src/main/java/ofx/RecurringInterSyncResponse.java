 ...
 *       
 * 
 * <p>Java class for RecurringInterSyncResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RecurringInterSyncResponse">
 *   &lt;complexContent>
 ...
 *         &lt;/choice>
 *         &lt;element name="RECINTERTRNRS" type="{http://ofx.net/types/2003/04}RecurringInterTransactionResponse" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RecurringInterSyncResponse", propOrder = {
    "bankacctfrom",
    "ccacctfrom",
    "recintertrnrs"
})
public class RecurringInterSyncResponse
    extends AbstractSyncResponse
{
    ...
    @XmlElement(name = "RECINTERTRNRS")
    protected List<RecurringInterTransactionResponse> recintertrnrs;
    ...
    /**
     * Gets the value of the recintertrnrs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the recintertrnrs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRECINTERTRNRS().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RecurringInterTransactionResponse> getRECINTERTRNRS() {
        if (recintertrnrs == null) {
            recintertrnrs = new ArrayList<RecurringInterTransactionResponse>();
        }
        return this.recintertrnrs;
    }
