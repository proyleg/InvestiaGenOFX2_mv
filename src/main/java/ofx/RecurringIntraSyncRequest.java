 ...
 *       
 * 
 * <p>Java class for RecurringIntraSyncRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RecurringIntraSyncRequest">
 *   &lt;complexContent>
 ...
 *         &lt;/choice>
 *         &lt;element name="RECINTRATRNRQ" type="{http://ofx.net/types/2003/04}RecurringIntraTransactionRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "RecurringIntraSyncRequest", propOrder = {
    "bankacctfrom",
    "ccacctfrom",
    "recintratrnrq"
})
public class RecurringIntraSyncRequest
    extends AbstractSyncRequest
{
    ...
    @XmlElement(name = "RECINTRATRNRQ")
    protected List<RecurringIntraTransactionRequest> recintratrnrq;
    ...
    /**
     * Gets the value of the recintratrnrq property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the recintratrnrq property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRECINTRATRNRQ().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RecurringIntraTransactionRequest> getRECINTRATRNRQ() {
        if (recintratrnrq == null) {
            recintratrnrq = new ArrayList<RecurringIntraTransactionRequest>();
        }
        return this.recintratrnrq;
    }
