 ...
 *       
 * 
 * <p>Java class for InterSyncResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InterSyncResponse">
 *   &lt;complexContent>
 ...
 *         &lt;/choice>
 *         &lt;element name="INTERTRNRS" type="{http://ofx.net/types/2003/04}InterTransactionResponse" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "InterSyncResponse", propOrder = {
    "bankacctfrom",
    "ccacctfrom",
    "intertrnrs"
})
public class InterSyncResponse
    extends AbstractSyncResponse
{
    ...
    @XmlElement(name = "INTERTRNRS")
    protected List<InterTransactionResponse> intertrnrs;
    ...
    /**
     * Gets the value of the intertrnrs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the intertrnrs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getINTERTRNRS().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<InterTransactionResponse> getINTERTRNRS() {
        if (intertrnrs == null) {
            intertrnrs = new ArrayList<InterTransactionResponse>();
        }
        return this.intertrnrs;
    }
