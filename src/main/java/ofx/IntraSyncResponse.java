 ...
 *       
 * 
 * <p>Java class for IntraSyncResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="IntraSyncResponse">
 *   &lt;complexContent>
 ...
 *         &lt;/choice>
 *         &lt;element name="INTRATRNRS" type="{http://ofx.net/types/2003/04}IntraTransactionResponse" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "IntraSyncResponse", propOrder = {
    "bankacctfrom",
    "ccacctfrom",
    "intratrnrs"
})
public class IntraSyncResponse
    extends AbstractSyncResponse
{
    ...
    @XmlElement(name = "INTRATRNRS")
    protected List<IntraTransactionResponse> intratrnrs;
    ...
    /**
     * Gets the value of the intratrnrs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the intratrnrs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getINTRATRNRS().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<IntraTransactionResponse> getINTRATRNRS() {
        if (intratrnrs == null) {
            intratrnrs = new ArrayList<IntraTransactionResponse>();
        }
        return this.intratrnrs;
    }
