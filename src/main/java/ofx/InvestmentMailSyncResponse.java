 ...
 *       
 * 
 * <p>Java class for InvestmentMailSyncResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InvestmentMailSyncResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="INVMAILTRNRS" type="{http://ofx.net/types/2003/04}InvestmentMailTransactionResponse" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "InvestmentMailSyncResponse", propOrder = {
    "invacctfrom",
    "invmailtrnrs"
})
public class InvestmentMailSyncResponse
    extends AbstractSyncResponse
{
    ...
    /**
     * Gets the value of the invmailtrnrs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the invmailtrnrs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getINVMAILTRNRS().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<InvestmentMailTransactionResponse> getINVMAILTRNRS() {
        if (invmailtrnrs == null) {
            invmailtrnrs = new ArrayList<InvestmentMailTransactionResponse>();
        }
